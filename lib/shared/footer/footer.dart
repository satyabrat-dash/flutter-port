...
class _FooterState extends State<Footer> {
  ...
  void _updateTime() {
    ...
    setState(() {
      _BhubaneshwarTime = formatter.format(gmt7Time);
    });
  }
  ...
  Widget _buildDesktopLayout(BuildContext context) => Row(
    ...
    children: [
      ...
      Text(
        'Bhubanehswar $_BhubaneshwarTime',
        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: AppColors.textPrimary.withValues(alpha: .7)),
      ),

      const Row(
        children: [
          _SocialIcon(icon: Icons.code, tooltip: 'GitHub', url: 'https://github.com/satyabrat-dash'),
          SizedBox(width: 16),
          _SocialIcon(icon: Icons.work, tooltip: 'LinkedIn', url: 'https://www.linkedin.com/in/satyabrat-dash/'),
          SizedBox(width: 16),
          _SocialIcon(
            icon: LucideIcons.instagram,
            tooltip: 'Instagram',
            url: 'https://www.instagram.com/_sa_ty_aaa_/',
          ),
        ],
      ),
    ],
